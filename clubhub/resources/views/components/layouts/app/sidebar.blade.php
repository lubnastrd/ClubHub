    ...
    <div class="flex min-h-screen">
        <aside class="w-64 sidebar-red text-white h-screen sticky top-0 p-4 space-y-6 shadow-xl overflow-y-auto" style="background: linear-gradient(180deg, #dc2626 0%, #b91c1c 100%);">
            ...
            <div class="mt-auto pt-4 border-t border-red-600">
                ...
                <div class="space-y-1">
                    <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-2.5 rounded-lg hover:bg-red-800 transition-all duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Konten Halaman -->
        <main class="flex-1 bg-gray-50 p-6 main-content">
            @yield('content')
        </main>
    </div>
